...
var dummyData = [{ taskText: 'Clean Dishes', completed: true }, { taskText: 'Wash Dishes', completed: false }, { taskText: 'Watch TV', completed: false }, { taskText: 'Code', completed: false }];

var dataText = dummyData.map(function (todo) {
...
var TodoApp = function (_React$Component) {
  ...
  _createClass(TodoApp, [{
    ...
    value: function addTodo(toDo) {
      ...
      _axios2.default.post("/db/add").then(function (response) {
    ...
    value: function toggleToDo(index) {
      var task = dataText.indexOf(index);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_InputLine2.default, { submit: function submit(toDo) {
            return _this2.addTodo(toDo);
          } }),
        _react2.default.createElement(_TodoList2.default, { taskText: dataText, todoClickText: function todoClickText(index) {
            return _this2.toggleToDo(index);
          }, todoClickX: function todoClickX(index) {
...
var _ToDoApp = __webpack_require__(20);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { method: 'POST', action: '/db/add', onClick: function onClick() {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { onClick: function onClick() {
              ...
              }, className: 'fin-input btn-sm btn btn-success' },
            'X'
          ),
          this.props.task.completed ? _react2.default.createElement(
            'strike',
            { onClick: function onClick() {
                return _this2.props.textClick();
              } },
...
var TodoList = function (_React$Component) {
  ...
  _createClass(TodoList, [{
    ...
    value: function getIndex(item) {
      var listArr = [];
      var listText = this.props.todos.forEach(function (todo) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.todos.map(function (todo) {
          return _react2.default.createElement(_Todo2.default, { textClick: function textClick() {
              return _this2.props.todoClickText(_this2.props.taskText.indexOf(todo.taskText));
            },
            xClick: function xClick() {
              return _this2.props.todoClickX(_this2.props.taskText.indexOf(todo.taskText));
            }, task: todo });
        })
      );
    }
...
*/
var aa=__webpack_require__(6),ba=__webpack_require__(2),m=__webpack_require__(14),p=__webpack_require__(7),v=__webpack_require__(4),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(15),ha=__webpack_require__(5);
